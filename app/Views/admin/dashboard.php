...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-3xl p-6 border border-[#EDEDED] shadow-2xs">
        ...
        <div class="font-display text-[32px] font-extrabold text-[#252525] leading-none mb-2">
            <?= esc($inquiryCounts['total'] ?? 0) ?>
        </div>
        <div class="text-[12.5px] text-[#6F6F6F]">
    ...
    <div class="bg-white rounded-3xl p-6 border border-[#EDEDED] shadow-2xs">
        ...
        <div class="font-display text-[32px] font-extrabold text-[#ED709E] leading-none mb-2">
    ...
    <div class="bg-white rounded-3xl p-6 border border-[#EDEDED] shadow-2xs">
        <div class="flex items-center justify-between mb-4">
            <span class="text-[12px] font-bold tracking-[0.5px] uppercase text-[#6F6F6F] font-display">Published Blogs</span>
